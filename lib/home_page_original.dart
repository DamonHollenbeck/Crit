...
class _HomePageState extends State<HomePage> {
  ...
  Future<void> startChat(String context, String message) async {
    var chat = model.startChat(history: [
      Content.text(
          "You are a world renowned art teacher, known both for kindess and excellency of advice, as well as technical ability and knowledge. You are known for your ability to teach students of all levels, from beginners to advanced. NEVER, under any circumstance, should you include any asterisk (Ex: '**') in your output."),
